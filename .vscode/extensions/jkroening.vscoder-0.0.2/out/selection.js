...
exports.extendSelection = exports.getSelection = exports.surroundSelection = exports.getWordOrSelection = void 0;
const vscode_1 = require("vscode");
const lineCache_1 = require("./lineCache");
function getWordOrSelection() {
    ...
    if ((selection.start.line === selection.end.line) &&
        ...
        text = currentDocument.getText(vscode_1.window.activeTextEditor.selection);
    }
    return text;
}
exports.getWordOrSelection = getWordOrSelection;
function surroundSelection(text, rFunctionName) {
...
exports.surroundSelection = surroundSelection;
function getSelection() {
    ...
    if (selection.range.isEmpty) {
        ...
        selection.range = new vscode_1.Range(newStart, newEnd);
    }
        ...
        if (quoteChar === '') {
            ...
            if (nextChar === quoteChar) {
                if (lookingForward) {
                    ...
                    const next = getNextChar(poss[lookingForward ? 1 : 0], lookingForward, getLineFromCache, getEndsInOperatorFromCache, lineCount);
                    if (next.nextChar !== '\\') {
                        quoteChar = '';
                    }
                }
